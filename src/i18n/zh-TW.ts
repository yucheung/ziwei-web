export const zhTW = {
  ...
  'fortune.timeline': '大限流分析圖',
  'fortune.timelineHint': '點選大限查看宮位、主星、四化與生活主題',
  'fortune.selectedDecadal': '選取的大限詳情',
  'fortune.selectPeriod': '查看詳情',
  'fortune.theme': '主題',
  'fortune.noThemes': '暫無可對應的主題資料',
  'fortune.noDecadalPeriods': '目前沒有可顯示的大限資料。',
  ...
  'specialTopic.chooseTopic': '選擇專題',
  'specialTopic.career': '事業',
  'specialTopic.wealth': '財運',
  'specialTopic.relationship': '感情',
  'specialTopic.health': '健康',
  'specialTopic.education': '學業',
  'specialTopic.generate': '生成專題解讀',
  'specialTopic.stop': '停止生成',
  'specialTopic.loading': 'AI 正在生成專題解讀…',
  'specialTopic.hint': '選擇專題後生成解讀',
  'specialTopic.noApiKey': '尚未設定 API Key，請先在命盤解讀面板設定。',
  'specialTopic.error': '專題解讀失敗：{message}',
  'specialTopic.completed': '專題解讀已完成',
  'specialTopic.aborted': '專題解讀已中止',
  'specialTopic.timeout': '專題解讀逾時中斷，內容可能不完整',
  'specialTopic.sources': '知識來源',
  ...
  'collection.namePlaceholder': '輸入名稱（選填）',
  'collection.saveCurrent': '儲存目前命盤',
  'collection.empty': '尚未儲存命盤',
  'collection.loading': '正在載入已儲存命盤…',
  'collection.solarDate': '陽曆',
  'collection.lunarDate': '陰曆',
  'collection.birthTime': '出生時辰',
  'collection.savedAt': '儲存日期',
  'collection.load': '載入',
  'collection.rename': '重新命名',
  'collection.saveName': '儲存名稱',
  'collection.cancel': '取消',
  'collection.delete': '刪除',
  'collection.deleteConfirm': '確定要刪除「{name}」嗎？此操作無法復原。',
  'collection.saved': '已儲存目前命盤',
  'collection.renamed': '已更新命盤名稱',
  'collection.deleted': '已刪除命盤',
  'collection.error': '無法更新命盤收藏，請稍後再試。',
  'collection.nameRequired': '請輸入命盤名稱。',
  'collection.untitled': '未命名命盤',
