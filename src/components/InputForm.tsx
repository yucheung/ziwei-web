  ...
  return (
    <div className="glass-panel p-6 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 transition-colors">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1.5">{t('form.calendarType')}</label>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/50"
          />
        </div>
        ...
        {/* Gender */}
        <div>
          <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1.5">{t('form.gender')}</label>
