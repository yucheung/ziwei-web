...
describe('starKnowledge', () => {
  it('contains the 26 canonical stars with stable provenance and attributes', () => {
    ...
    expect(new Set(entries.map((entry) => entry.knowledgeId)).size).toBe(26);
